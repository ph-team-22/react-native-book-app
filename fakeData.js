const fakeData = [
...

  {
    ...
    imageLink: "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1391032531l/515601.jpg",
    ...
    reviews: [
      {
        name: "Danny",
        rating: 5,
        review: " This is it. Even after all these years, it's still the go-to resource for learning about C programming. Some call it 'the C bible'.",
      },
    ],
  },

  {
    ...
    imageLink: "https://books.google.com.bd/books/publisher/content?id=UAYvDwAAQBAJ&printsec=frontcover&img=1&zoom=1&h=640",
    ...
    reviews: [
      {
        ...
        rating: 5,
        review: "The book is very good and can be complex when you get into details. It is one of the best fee books you can download. Practice more and you will get it done.",
      },
      {
        name: "Ubokudom Ubokudom",
        rating: 5,
        review: "I have found this book very useful on my Journey to programming. A must read for all programmers. cheers",
      },
    ],
  },

  {
    ...
    author: "Jon Bentley",
    imageLink: "https://books.google.com.bd/books/content?id=vyhrriC6qcEC&printsec=frontcover&img=1&zoom=1&h=640",

    link: "https://books.google.com.bd/books?id=vyhrriC6qcEC&source=gbs_navlinks_s",
    pages: 256,
    description: "The essays in this book present programs that go beyond solid engineering techniques to be creative and clever solutions to computer problems. The programs are fun and teach important programming tecniques and fundamental design principles.",
    reviews: [],
  },

  {
    ...
    imageLink: "https://books.google.com.bd/books/publisher/content?id=iptCAwAAQBAJ&printsec=frontcover&img=1&zoom=1&h=640",
    ...
    reviews: [
      {
        name: "NITHIN M A",
        rating: 5,
        review: "The best book ever about computer science. Well structured and coherent prose that elucidates complex ideas in simple terms for average readers. Truly a great read for innovative minds",
      },
      {
        name: "Missoum Said",
        rating: 5,
        review: "incredible how computer works explained in here, the flow from the very first computer that made of wooden to the digital computer we know now, dissected every piece to very smallest possible makes it easy to understand.",
      },
    ],
  },

  {
    ...
    title: "Design Patterns: Elements of Reusable Object-Oriented Software",
    author: "Erich Gamma",
    imageLink: "https://books.google.com.bd/books/content?id=K4qv1D-LKhoC&printsec=frontcover&img=1&zoom=1&h=640",
    ...
    reviews: [
      {
        name: "scottjpearson - LibraryThing",
        rating: 5,
        review: "A classic in the field of computer science, this book describes how object-oriented software can be used to develop meaningful (and reusable) classes. It is written by the so-called 'gang of four'",
      },
      {
        name: "User review",
        rating: 5,
        review: "Depending on on how you think of programming, this book could be incredibly insightful, or horribly abstract and impractical. Since I prefer and tend to think in patterns and abstractions,",
      },
    ],
  },

  {
    ...
    author: "Al Sweigart",
    imageLink: "https://books.google.com.bd/books/publisher/content?id=8AcvDwAAQBAJ&printsec=frontcover&img=1&zoom=1&h=640",
